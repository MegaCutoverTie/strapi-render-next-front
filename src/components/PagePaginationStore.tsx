...
const PagePaginationStore = ({pagination}: Props) => {
  ...
  return (
    ...
    <nav aria-label="Page navigation example" className="text-center pb-8">
        ...
        <li>
            <Link
            href={
                page === 1 ? `/store?page=${page}` : `/store?page=${page - 1}`
            }
            className={prev}
            >
        ...
        <li>
            <Link
            href={
                page === pageCount ? `/store?page=${page}` : `/store?page=${page + 1}`
            }
            className={next}
            >
...
export default PagePaginationStore